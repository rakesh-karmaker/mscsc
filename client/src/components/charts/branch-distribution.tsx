...
export default function BranchDistributionChart({
  ...
  return (
    <div className="branch-distribution w-fit min-w-86.5 max-[880px]:w-full p-5! rounded-lg mb-6 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] flex flex-col gap-6">
