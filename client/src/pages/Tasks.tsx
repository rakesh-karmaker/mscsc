...
export default function Tasks({ admin }: { admin?: boolean }) {
  ...
  return (
    <>
      {/* page meta data */}
      <Helmet>
        <title>MSCSC - Tasks</title>
        <meta property="og:title" content="MSCSC - Tasks" />
        <meta name="twitter:title" content="MSCSC - Tasks" />
        <meta name="og:url" content="https://mscsc.netlify.app/tasks" />
        <link rel="canonical" href={`https://mscsc.netlify.app/tasks`} />
      </Helmet>
