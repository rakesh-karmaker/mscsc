// Event Confirmation Draft
export interface EventConfirmationDraftProps {
  eventName: string;
  logoUrl: string;
  code: string;
  name: string;
...
export function eventConfirmationDraft({
  eventName,
  logoUrl,
  code,
  name,
                                ...
                                <td>
                                    <center>
                                        <p
                                            ...
                                            Get ready for mind-blowing problems, friendly competition, and new friends.
                                        </p>
                                    </center>
                                </td>
                            </tr>
...
// Event Rejection Draft
interface EventRejectionDraftProps {
  eventName: string;
  reason: string;
  logoUrl: string;
}

export function eventRejectionDraft({
  eventName,
  reason,
  logoUrl,
}: EventRejectionDraftProps) {
  const year = new Date().getFullYear();
  return `
    <!DOCTYPE html
        PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css"
            integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkPKZ5QiAj6Ta86w+fsb2TkcmfRyVX3pBnMFcV7oQPJkl9QevSCWr3W6A=="
            crossorigin="anonymous" referrerpolicy="no-referrer" />
        <title>${eventName} Registration Rejected</title>
    </head>
                        ...
                        <table class="top" style="border-spacing: 0;width: 100%; height: 100%; background-color: #fff8ec;">
                            ...
                            <tr>
                                <td>
                                    <h2
                                        style="margin: 0; padding: 0 20px; font-size: 32px; font-weight: 500; line-height: 39px; letter-spacing: 0.01em; text-align: center; margin-top: 20px;  color: #1d4b52;">
                                        Registration Rejected for ${eventName}!
                                    </h2>
                                </td>
                            </tr>
                            <tr>
