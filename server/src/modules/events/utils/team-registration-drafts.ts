...
export function teamRegistrationRejectionDraft({
  eventName,
  logoUrl,
  teamName,
  leaderEmail,
  ...
  segmentName,
  rejectionReason,
}: Omit<TeamRegistrationConfirmationDraftProps, "name"> & {
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>${eventName} Team Registration Rejection</title>
</head>
                        ...
                        <tr>
                            <td>
                                <center>
                                    <p
                                        style="margin: 10px 0 0px 0; padding: 0 10px; font-size: 20px; max-width: 90%; text-align: center; color: #1d4b52; opacity: 0.8;">
                                        Your team details for the event have been rejected.
                                    </p>
                                </center>
                            </td>
                        </tr>
